...
def create_vcard(overrides=None) -> vobject.vCard:
    ...
    set_property("PHOTO", overrides.pop("PHOTO", ("URI", "https://justiceleague.org")))
    ...
    set_property("RELATED", overrides.pop("RELATED", [("co-worker", "uuid:alfred-id-101")]))
    set_property("ORG", overrides.pop("ORG", ["Wayne Enterprises", "Tech Division"]))
    set_property("LOGO", overrides.pop("LOGO", ("URI", "https://wayneenterprises.com")))
    set_property("CATEGORIES", overrides.pop("CATEGORIES", ["Billionaire", "Hero"]))
    set_property("NOTE", overrides.pop("NOTE", "High-profile billionaire tech investor."))
    set_property("SOUND", overrides.pop("SOUND", ("URI", "https://wayneenterprises.com")))
    ...
    set_property("CALADRURI", overrides.pop("CALADRURI", "mailto:bruce@waynecorp.com"))
    ...
    set_property("XML", overrides.pop("XML", "<customData xmlns='http://example.com'>Batman</customData>"))
    set_property("PRODID", overrides.pop("PRODID", "-//Custom Enterprise Generator V1.0//EN"))
    set_property("REV", overrides.pop("REV", "2026-08-06T21:24:00Z"))
    set_property("UID", overrides.pop("UID", "urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6"))
    set_property(
        "CLIENTPIDMAP",
        overrides.pop("CLIENTPIDMAP", "1;urn:uuid:53e374d9-317a-48da-a156-cb31a1ec329e"),
    )
...
def test_vcf_accepts_non_default_version_5p0(tmp_path: Path):
    # This test shows that if vcards are updated in the future, any version number works
    result = write_and_extract(
...
def test_vcf_renders_custom_attribute(tmp_path: Path):
    ...
    result = write_and_extract(create_vcard(overrides={"X-CUSTOM": "made up value"}), tmp_path)
